---
title: "Transversalidad de conocimientos de los programas educativos"
---
...
legend(-0.4,0.7, legend=levels(as.factor(V(net)$Área)), 
...
plot(net, 
     ...
     layout=lgl)
# Se agrega la leyenda
legend(-0.6,-0.7, legend=levels(as.factor(V(net)$Área)), 
       col = colores , bty = "n", pch=20 , pt.cex = 3, cex = 1.0, 
       text.col=colores , horiz = FALSE, inset = c(0.1, 0.1))
```